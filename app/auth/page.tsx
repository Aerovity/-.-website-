...
export default function AuthPage() {
  ...
  const handleSpotlightAuth = (authMode: "login" | "register") => {
    setMode(authMode)
  }
            ...
            <div className="space-y-8">
              ...
              <div className="text-center">
                <h1 className="text-3xl font-bold text-white mb-2">
                  {mode === "login" ? t.welcomeBack : t.joinKarasu}
                </h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                {mode === "register" && (
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="h-12 bg-gray-900/50 border-gray-700 text-white placeholder:text-gray-500 focus:border-gray-500 focus:ring-1 focus:ring-gray-500"
                      required
                    />
                  </div>
                )}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="h-12 bg-gray-900/50 border-gray-700 text-white placeholder:text-gray-500 focus:border-gray-500 focus:ring-1 focus:ring-gray-500 pr-12"
                      required
                    />
                    <button
                      type="button"
                ...
                {/* Submit Button using SpotlightButton style */}
                <Button
                  type="submit"
                  className="w-full h-12 relative overflow-hidden bg-gradient-to-r from-gray-800 to-gray-900 hover:from-gray-700 hover:to-gray-800 text-white border border-gray-600 transition-all duration-300 group"
                >
                  <span className="relative z-10 font-semibold">{mode === "login" ? t.signIn : t.createAccount}</span>
                  {/* Spotlight effect */}
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-black text-gray-400">{t.orContinueWith}</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <Button
                  type="button"
                  variant="outline"
                  className="h-12 bg-gray-900/50 border-gray-700 text-white hover:bg-gray-800/50 hover:border-gray-600"
                >
              ...
              {/* Switch Mode */}
              <div className="text-center">
                <p className="text-gray-400 text-sm">{mode === "login" ? t.dontHaveAccount : t.alreadyHaveAccount}</p>
                <button
                  type="button"
                  onClick={() => setMode(mode === "login" ? "register" : "login")}
                  className="text-white hover:text-gray-300 font-medium text-sm mt-1 underline underline-offset-4"
                >
